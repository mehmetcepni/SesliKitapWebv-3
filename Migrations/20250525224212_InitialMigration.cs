        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookRecommendations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCompleted = table.Column<bool>(type: "bit", nullable: false),
                    ReadingTime = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserReadingHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserReadingHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fıkra kitapları", "Fıkra" },
                    { 2, "Çocuk hikayeleri kitapları", "Çocuk Hikayeleri" },
                    { 3, "Roman türü kitaplar", "Roman" },
                    { 4, "Tarih kitapları", "Tarih" },
                    { 5, "Biyografi kitapları", "Biyografi" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserReadingHistories_UserId",
                table: "UserReadingHistories",
                column: "UserId");
        }
